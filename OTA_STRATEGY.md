...
เอกสารฉบับนี้จัดทำขึ้นเพื่อกำหนด **"แนวทางสากลในการแก้ปัญหาแอปค้าง (Anti-Freeze Guidelines)"** และ **"สถาปัตยกรรมการอัปเดตทางไกลแบบถาวร (Two-Tier OTA System)"** สำหรับระบบตู้จ่ายน้ำ Aqua Station เพื่อการดูแลรักษาจากทางไกลแบบ 100% (Zero-Visit Maintenance)
...
3.  **ระบบการอัปเดตโดยผู้ใช้ยืนยัน (Non-Rooted):**
    *   หากเครื่องไม่ได้ Root ระบบจะดาวน์โหลดไฟล์ APK และเด้งหน้าต่าง Android Package Installer ขึ้นมาเพื่อให้ผู้ดูแลหน้าตู้กดคำว่า "ตกลง" เพื่ออัปเกรดแอปด้วยตัวเองเพียงปุ่มเดียว

---

## 🛠️ ส่วนที่ 3: แผนปฏิบัติการสำรองเพื่อการกู้ภัย (Zero-Failure Disaster Plan)
